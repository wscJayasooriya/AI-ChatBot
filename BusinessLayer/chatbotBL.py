...
def chat_bow(text):
    ...
    #print(lemma)
    project_path = 'C:\\Users\\admin\\Desktop\\New Project\\AI-ChatBot-master'
    file_path = os.path.join(project_path, 'Data', 'english', 'dialog_talk_agent.xlsx')
    # file_path = os.path.join(project_path, 'Data', 'english', 'data_set.xlsx')
